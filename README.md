...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-server-proxy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-server-proxy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-server-proxy
# for installing globally
pixi global install jupyter-server-proxy
```
...
It is possible to list all of the versions of `jupyter-server-proxy` available on your platform:
...
```
pixi search jupyter-server-proxy --channel conda-forge
```
